          ...
          <div class="col-md-4">
            <div class="card text-center mb-3">
              @if (!$loket3->count())
                <h5>Belum Ada Antrian</h5>
              @else
                <h5 class="card-header bg-primary text-white">ANTRIAN {{ strtoupper($loket3[0]->loket->deskripsi) }}</h5>
                <div class="card-body">
                  <h5 class="card-title">Nomor Antrian</h5>
                  <h1 class="card-text" id="loket3-antrian" style="font-size: 100px; margin: 0;">{{ $loket3[0]->no_antrian }}</h1>
                </div>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card mt-2 border-0" style="background-color: rgba(0, 0, 0, 0)">
              <div class="card-body">
                <div id="carouselExampleInterval" class="carousel slide carousel-custom" data-bs-ride="carousel">
