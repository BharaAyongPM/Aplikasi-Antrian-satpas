        ...
        <div class="col-md-4 p-5 shadow-sm border rounded-5 border-primary">
            ...
            <form method="post" action="/login">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control bg-info bg-opacity-10 border border-primary @error('username') is-invalid @enderror" name="username" id="username" autofocus value="{{ old('username') }}">
                    @error('username')
